...
//Khi co da duoc ha xuong den chan cot
bool Flag::isDown() const
{
	return (stepsCounter >= 506);
}

//Cai dat pham vi toa do x sao cho khi Mario tien vao thi duoc coi la "Hit The Flag"
...
//Dieu chinh toa do y de tao hieu ung ha co xuong
...
//Hien thi cot co tuy theo layout style 
