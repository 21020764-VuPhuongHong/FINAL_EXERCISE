...
//Neu Mario dang o trang thai Small thi chuyen sang trang thai Super Mario (lon len), neu dang o trang thai Super Mario 
// va khong o trang thai Immortal (bat tu) thi sau khi an Flower se chuyen sang Fire Mario (co the ban ra qua cau lua)
