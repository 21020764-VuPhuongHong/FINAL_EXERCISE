...
void Level::setFirstLevel(World &world, bool checker)
{
	...
	world.inanimateElements.push_back(std::make_shared<Castle>(Castle(Position(6542, 285), false)));
...
void Level::setSecondLevel(World &world, bool checker)
{
	...
	world.inanimateElements.push_back(std::make_shared<Castle>(Castle(Position(6684, 285), false)));
	world.flag = nullptr;
	world.button = nullptr;
}
...
void Level::setThirdLevel(World &world)
{
	...
	world.inanimateElements.push_back(std::make_shared<Castle>(Castle(Position(80, 285), false)));
	...
	world.inanimateElements.push_back(std::make_shared<Castle>(Castle(Position(5135, 150), true)));
...
void Level::setFourthLevel(World &world)
{
	...
	world.npcs.push_back(std::make_shared<FireMissile>(FireMissile(Position(3200, 235), MissileType::Rocket)));
	world.npcs.push_back(std::make_shared<FireMissile>(FireMissile(Position(4000, 280), MissileType::Rocket)));
	world.npcs.push_back(std::make_shared<FireMissile>(FireMissile(Position(4450, 200), MissileType::Rocket)));
...
void Level::setSecondStageOnSecondLevel(World &world)
{
	...
	world.inanimateElements.push_back(std::make_shared<Castle>(Castle(Position(915, 285), false)));
...
void Level::setWinterWorld(World &world)
{
	...
	world.npcs.push_back(std::make_shared<FireMissile>(FireMissile(Position(3640, 300), MissileType::Rocket)));
	...
	world.npcs.push_back(std::make_shared<FireMissile>(FireMissile(Position(7800, 224), MissileType::Rocket)));
...
void Level::setSecondStageOnWinterWorld(World &world)
{
	...
	world.npcs.push_back(std::make_shared<FireMissile>(FireMissile(Position(1450, 315), MissileType::Rocket)));
	...
	world.npcs.push_back(std::make_shared<FireMissile>(FireMissile(Position(2050, 250), MissileType::Rocket)));
	world.npcs.push_back(std::make_shared<FireMissile>(FireMissile(Position(2050, 365), MissileType::Rocket)));
	world.npcs.push_back(std::make_shared<FireMissile>(FireMissile(Position(2800, 240), MissileType::Rocket)));
	world.npcs.push_back(std::make_shared<FireMissile>(FireMissile(Position(3110, 283), MissileType::Rocket)));
	world.npcs.push_back(std::make_shared<FireMissile>(FireMissile(Position(2400, 75), MissileType::Rocket)));
	...
	world.npcs.push_back(std::make_shared<FireMissile>(FireMissile(Position(3330, 252), MissileType::Rocket)));
	...
	world.npcs.push_back(std::make_shared<FireMissile>(FireMissile(Position(1755, 132), MissileType::Rocket)));
