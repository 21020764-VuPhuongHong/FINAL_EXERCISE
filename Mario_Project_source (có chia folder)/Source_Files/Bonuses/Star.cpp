...
void Star::makeVerticalMove(World &world)
{
	...
	if (alignment > 0) {
		movement.setVerticalDirection(movement.getVerticalDirection() == Direction::Down ? Direction::Up : Direction::Down);
...
//An duoc ngoi sao thi Mario chuyen sang trang thai Immortal (bat tu) trong mot thoi gian 
