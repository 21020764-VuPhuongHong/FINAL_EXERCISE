...
* Cách 1: Download Mario_game_exe.rar trong repo này về và giải nén, mở file MarioGame.exe trong đó để bắt đầu chơi
* Cách 2:
...
### Mô tả chung:
 ...
 ## 3. Các chức năng đã cài đặt <br> 
  > Link video minh họa: https://youtu.be/KVG29wEgGTA
